<?php
/**
 * رأس صفحات الطالب - منصة همّة التوجيهي
 * Student Header - Himma Tawjihi Platform
 */
...
<head>
    ...
    <title><?php echo $page_title ?? 'لوحة الطالب'; ?> - منصة همّة التوجيهي</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    <?php echo renderChatAndNotificationIcons($_SESSION['user_id'], $_SESSION['role']); ?>
